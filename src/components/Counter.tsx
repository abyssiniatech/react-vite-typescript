...
// set the logic of the program
 
const mainEl=document.getElementById("bb")
const bg1 =()=>{
    mainEl.style.fontSize="100%"
}
const bg2 =()=>{
  ...
  return (
    <div style={{ textAlign: "center" }} className="h-screen flex justify-center items-center bg-gray-100 text-white">
      <section className="bg-blue-800 p-44 shadow-lg rounded-lg hover:bg-blue-600 text-white">
        <h2 className="text-6xl mb-8">Counter App <span className="bg-inherit border-0 text-[20%]" onMouseEnter={bg1} onMouseLeave={bg2} id="bb">🔢</span></h2>
